...
process.env.VITE_APP_TITLE ??= process.env.OVERVIEW_TITLE ?? 'Dream Kids';
process.env.VITE_APP_DESCRIPTION ??= process.env.OVERVIEW_DESCRIPTION ?? 'Dream Kids kindergarten search app';
